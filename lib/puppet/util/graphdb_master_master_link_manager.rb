...
module Puppet
  module Util
    ...
    class GraphDBMasterMasterLinkManager
      ...
      def initialize(master_endpoint, master_repository_id,
                     peer_master_endpoint, peer_master_repository_id, peer_master_node_id)
